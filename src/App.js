...
export default class App extends Component {
  apiKey = process.env.REACT_APP_NEWS_API // API has taken from .env.local to hide api key for security purpose
  ...
  render() {
    return (
      ...
      />
          <Routes>
                 <Route exact path='/' element={ <News setProgress = {this.setProgress} apiKey = {this.apiKey}  key="" pageSize={12} country='in' category="business"/>}></Route>
                 ...
                 {/* <Route exact path='' element={ <News setProgress = {this.setProgress} apiKey = {this.apiKey}  key="" pageSize={12} country='in' category=""/>}></Route> */}
          </Routes>
      </Router>
      </> 
    )
